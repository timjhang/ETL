...
//							if(rowCount == 878378 || rowCount == 1334441 || rowCount == 1649065 ||rowCount == 2730198){
//								isPrint = true;
//							}else{
//								isPrint = false;
//							}
...
//										|| (!isFirstTime
//												&& (strQueue.getBytesListIndex() % ETL_Profile.ETL_E_Stage == 0))) {
//
//									// 記錄非初次
//									isFirstTime = false;
//									// 注入指定範圍筆數資料到QUEUE
...
//							}
							...
							System.out.println();
							System.out.println("第" + rowCount + "行 長度:" + strQueue.getTotalByteLength());
							// 區別碼檢核 c-1*
							String typeCode = strQueue.popBytesString(1);
							...
							System.out.println("本會代號檢核(7):" + domain_id.getBytes().length);
							...
							System.out.println("客戶統編檢核(11):" + party_number.getBytes().length);
							...
							System.out.println("異動代號檢核(1):" + change_code.getBytes().length);
							data.setChange_code(change_code);
							// 檢核內容至分出本行/非本行客戶後進行

							// 是否為本行客戶 c-*5(1)
							String my_customer_flag = strQueue.popBytesString(1);
							System.out.println("是否為本行客戶(1):" + my_customer_flag.getBytes().length);
							...
							if ("Y".equals(my_customer_flag)) {
								...
								System.out.println("歸屬本/分會代號 (7):" + branch_code.getBytes().length);
								...
								System.out.println("顧客類型 (3):" + entity_type.getBytes().length);
								...
								System.out.println("客戶子類型 (1):" + entity_sub_type.getBytes().length);
...
//								if(isPrint){
								System.out.println("中文名字 (40):" + party_first_name_1.getBytes().length);
								System.out.println("中文名字:"+party_first_name_1);
//								}
...
//								if(isPrint){
								System.out.println("中文姓氏 (80):" + party_last_name_1.getBytes().length);
								System.out.println("中文姓氏:"+party_last_name_1);
//								}
								...
								System.out.println("出生年月日/創立日期(8) :" + date_of_birth.getBytes().length);
								...
								System.out.println("亡故日期(8) :" + deceased_date.getBytes().length);
								...
								System.out.println("國籍(2) :" + nationality_code.getBytes().length);
								...
								} else if ("　".equals(nationality_code)) { // 國籍代碼防全形空白錯誤
																			// 2018.03.28
								...
								System.out.println("英文名字(40) :" + party_first_name_2.getBytes().length);
								...
								System.out.println("英文姓氏(80) :" + party_last_name_2.getBytes().length);
								...
								System.out.println("顧客開戶日期(8) :" + open_date.getBytes().length);
								...
								System.out.println("顧客結清日期(8) :" + close_date.getBytes().length);
								...
								System.out.println("性別(1) :" + gender.getBytes().length);
								...
								System.out.println("年收入(法人)(10) :" + annual_income.getBytes().length);
								...
								System.out.println("職業/行業(6) :" + occupation_code.getBytes().length);
								...
								System.out.println("婚姻狀況(1) :" + marital_status_code.getBytes().length);
								...
								System.out.println("服務機構(30) :" + employer_name.getBytes().length);
								...
								System.out.println("服務機構統編(8) :" + employer.getBytes().length);
								...
								System.out.println("行內員工註記(1) :" + employee_flag.getBytes().length);
								...
								// 出生地 c-25(18)
								String place_of_birth = strQueue.popBytesDiffString(18);
								System.out.println("出生地(18) :" + place_of_birth.getBytes().length);
								System.out.println("出生地:"+place_of_birth);
								...
								System.out.println("是否具多重國籍(自然人)(1) :" + multiple_nationality_flag.getBytes().length);
								// System.out
								...
								System.out.println("第二國籍(2) :" + nationality_code_2.getBytes().length);
								...
								} else if ("　".equals(nationality_code_2)) { // 國籍代碼防全形空白錯誤
																				// 2018.03.28
								...
								System.out.println("顧客電子郵件(80) :" + email_address.getBytes().length);
								...
								System.out.println("金融卡約定服務(1) :" + registered_service_atm.getBytes().length);
								...
								System.out.println("電話約定服務(1) :" + registered_service_telephone.getBytes().length);
								...
								System.out.println("傳真約定服務(1) :" + registered_service_fax.getBytes().length);
								...
								System.out.println("網銀約定服務(1) :" + registered_service_internet.getBytes().length);
								...
								System.out.println("行動銀行約定服務(1) :" + registered_service_mobile.getBytes().length);
								...
								System.out.println("是否得發行無記名股票 (法人)(1) :" + bearer_stock_flag.getBytes().length);
								// System.out.println("是否得發行無記名股票 (法人)
								// c-34(1):"
								...
								System.out
										.println("無記名股票 (法人)資訊說明 (40) :" + bearer_stock_description.getBytes().length);
								// System.out.println(
								// "無記名股票 (法人)資訊說明 c-35(40):" +
								...
								System.out.println("外國人士居留或交易目的(80) :" + bearer_stock_description.getBytes().length);
								// System.out.println(
								// "外國人士居留或交易目的 c-36(80):" +
								...
								System.out.println("顧客AUM餘額(14) :" + total_asset.getBytes().length);
								...
								System.out.println("信託客戶AUM餘額(14) :" + trust_total_asset.getBytes().length);
					...
					// // 寫入Error_Log
					// ETL_P_Log.write_Error_Log(batch_no, exc_central_no,
					// exc_record_date, null, fileTypeName, upload_no,
			...
			try {
				...
				// batch_no, exc_central_no, exc_record_date, upload_no,
				// program_no);
			...
			if (fileList.size() == 0) {
				...
				// 寫入Error_Log
				// ETL_P_Log.write_Error_Log(batch_no, exc_central_no,
				// exc_record_date, null, fileTypeName, upload_no, "E",
			...
			// 處理後更新ETL_Detail_Log
			// ETL_P_Log.update_End_ETL_Detail_Log(batch_no, exc_central_no,
			// exc_record_date, upload_no, "E", program_no,
			// "E", detail_exe_result, detail_exe_result_description, new
			// Date());
	...
	// insertAdapter.setSql("{call ADMINISTRATOR.SP_INSERT_PARTY_TEMP(?,?)}");
	// // 呼叫PARTY_PHONE寫入DB2 - SP
	...
	//
	// Boolean isSuccess =
	// ETL_P_Data_Writer.insertByDefineArrayListObject2(this.dataList,
	// insertAdapter);
	// int errorCount = insertAdapter.getErrorCount();
	//
	// if (isSuccess) {
	// System.out.println("insert_Party_Datas 寫入 " + this.dataList.size() + "(-"
	// + errorCount + ")筆資料!");
...
//				.readAllLines(Paths.get("D:\\PSC\\Projects\\AgriBank\\UNIT_TEST\\600_CF_PARTY_20180327.TXT"), charset);
//
//		if (lines.size() > 2) {
//
//			lines.remove(0);
...
//				System.out.println("是否為本行客戶X(01): " + new String(Arrays.copyOfRange(tmp, 20, 21), "Big5"));
//				System.out.println("歸屬本/分會代號X(07): " + new String(Arrays.copyOfRange(tmp, 21, 28), "Big5"));
//				System.out.println("顧客類型X(03): " + new String(Arrays.copyOfRange(tmp, 28, 31), "Big5"));
//				System.out.println("客戶子類型X(01): " + new String(Arrays.copyOfRange(tmp, 31, 32), "Big5"));
//				System.out.println("中文名字X(40): " + new String(Arrays.copyOfRange(tmp, 32, 72), "Big5"));
//				System.out.println("中文姓氏X(80): " + new String(Arrays.copyOfRange(tmp, 72, 152), "Big5"));
//				System.out.println("出生年月日/創立日期X(08): " + new String(Arrays.copyOfRange(tmp, 152, 160), "Big5"));
//				System.out.println("亡故日期X(08): " + new String(Arrays.copyOfRange(tmp, 160, 168), "Big5"));
//				System.out.println("國籍X(02): " + new String(Arrays.copyOfRange(tmp, 168, 170), "Big5"));
//				System.out.println("英文名字X(40): " + new String(Arrays.copyOfRange(tmp, 170, 210), "Big5"));
//				System.out.println("英文姓氏X(80): " + new String(Arrays.copyOfRange(tmp, 210, 290), "Big5"));
//				System.out.println("顧客開戶日期X(08): " + new String(Arrays.copyOfRange(tmp, 290, 298), "Big5"));
//				System.out.println("顧客結清日期X(08): " + new String(Arrays.copyOfRange(tmp, 298, 306), "Big5"));
//				System.out.println("性別X(01): " + new String(Arrays.copyOfRange(tmp, 306, 307), "Big5"));
//				System.out.println("年收入(法人)9(10): " + new String(Arrays.copyOfRange(tmp, 307, 317), "Big5"));
//				System.out.println("職業/行業X(06): " + new String(Arrays.copyOfRange(tmp, 317, 323), "Big5"));
//				System.out.println("婚姻狀況X(01): " + new String(Arrays.copyOfRange(tmp, 323, 324), "Big5"));
//				System.out.println("服務機構X(30): " + new String(Arrays.copyOfRange(tmp, 324, 354), "Big5"));
//				System.out.println("服務機構統編X(08): " + new String(Arrays.copyOfRange(tmp, 354, 362), "Big5"));
//				System.out.println("行內員工註記X(01): " + new String(Arrays.copyOfRange(tmp, 362, 363), "Big5"));
//				System.out.println("出生地X(18): " + new String(Arrays.copyOfRange(tmp, 363, 381), "Big5"));
//				System.out.println("是否具多重國籍(自然人)X(01): " + new String(Arrays.copyOfRange(tmp, 381, 382), "Big5"));
//				System.out.println("第二國籍X(02): " + new String(Arrays.copyOfRange(tmp, 382, 384), "Big5"));
//				System.out.println("顧客電子郵件X(80): " + new String(Arrays.copyOfRange(tmp, 384, 464), "Big5"));
//				System.out.println("金融卡約定服務X(01): " + new String(Arrays.copyOfRange(tmp, 464, 465), "Big5"));
//				System.out.println("電話約定服務X(01): " + new String(Arrays.copyOfRange(tmp, 465, 466), "Big5"));
//				System.out.println("傳真約定服務X(01): " + new String(Arrays.copyOfRange(tmp, 466, 467), "Big5"));
//				System.out.println("網銀約定服務X(01): " + new String(Arrays.copyOfRange(tmp, 467, 468), "Big5"));
//				System.out.println("行動銀行約定服務X(01): " + new String(Arrays.copyOfRange(tmp, 468, 469), "Big5"));
//				System.out.println("是否得發行無記名股票 (法人)X(01): " + new String(Arrays.copyOfRange(tmp, 469, 470), "Big5"));
//				System.out.println("無記名股票 (法人)資訊說明X(40): " + new String(Arrays.copyOfRange(tmp, 470, 510), "Big5"));
//				System.out.println("外國人士居留或交易目的X(80): " + new String(Arrays.copyOfRange(tmp, 510, 590), "Big5"));
//				System.out.println("顧客AUM餘額9(12)V99: " + new String(Arrays.copyOfRange(tmp, 590, 604), "Big5"));
//				System.out.println("信託客戶AUM餘額9(12)V99: " + new String(Arrays.copyOfRange(tmp, 604, 618), "Big5"));
//
//				System.out.println(
//						"============================================================================================");
//			}
//		}
		...
		one.read_Party_File(filePath, fileTypeName, "E7777829", "600",
				new SimpleDateFormat("yyyyMMdd").parse("20180327"), "001", "ETL_E_PARTY");
