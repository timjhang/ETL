...
public class ETL_T_LOAN_MASTER_LOAD {
	// 觸發DB2轉換Procedure, 轉換資料寫進LOAN_MASTER_LOAD  // TODO
		public void trans_to_LOAN_MASTER_LOAD(ETL_Bean_LogData logData) {
			
			System.out.println("#######Transform - ETL_T_LOAN_MASTER - Start"); // TODO
			...
			System.out.println("#######Transform - ETL_T_LOAN_MASTER - End"); // TODO
